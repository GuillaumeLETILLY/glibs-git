--@ Panel animation utilities with responsive scaling
local meta = FindMetaTable("Panel")

--@ Animate panel position to target with responsive scaling
...
--@ Animate panel's X position to target with responsive scaling
...
--@ Animate panel's Y position to target with responsive scaling
...
--@ Animate panel size to target with responsive scaling
...
--@ Animate panel width to target with responsive scaling
...
--@ Animate panel height to target with responsive scaling
...
--@ Animate panel to center with responsive scaling
...
--@ Animate panel to square size with responsive scaling
...
--@ Animate panel position and size simultaneously with responsive scaling
...
--@ Fade panel in with responsive delay
...
--@ Fade panel out with responsive delay
...
--@ Sequence of animations with responsive scaling
